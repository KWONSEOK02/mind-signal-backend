...
export type MatchingPoolDoc = HydratedDocument<MatchingPool, MatchingPoolMethods>;
export type MatchingPoolModel = Model<MatchingPool, {}, MatchingPoolMethods>;

/** 2. 스키마 정의 */
const matchingPoolSchema = new Schema<MatchingPool, MatchingPoolModel, MatchingPoolMethods>(
  {
...
export const MatchingPool = model<MatchingPool, MatchingPoolModel>('MatchingPool', matchingPoolSchema);
