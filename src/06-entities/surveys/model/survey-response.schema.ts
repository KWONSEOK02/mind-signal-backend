...
export type SurveyResponseDoc = HydratedDocument<SurveyResponse, SurveyResponseMethods>;
export type SurveyResponseModel = Model<SurveyResponse, {}, SurveyResponseMethods>;

/** 2. 스키마 정의 */
const surveyResponseSchema = new Schema<SurveyResponse, SurveyResponseModel, SurveyResponseMethods>(
  {
...
export const SurveyResponse = model<SurveyResponse, SurveyResponseModel>('SurveyResponse', surveyResponseSchema);
